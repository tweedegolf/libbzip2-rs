...
pub unsafe fn BZ2_decompress(s: &mut DState) -> i32 {
    ...
    match s.state {
        BZ_X_MAGIC_1 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v as u8;
                    ...
                    if (*s.strm).total_in_lo32 == 0 as libc::c_uint {
    ...
    if current_block == 15360092558900836893 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_0: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_0 as u8;
    ...
    if current_block == 15953825877604003206 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_1: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_1 as u8;
    ...
    if current_block == 1137006006685247392 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_2: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
    ...
    if current_block == 16838365919992687769 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_3: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_3 as u8;
    ...
    match current_block {
        14366592556287126287 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_32: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_32 as u8;
        ...
        5889181040567946013 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_4: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_4 as u8;
    ...
    match current_block {
        7651522734817633728 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_33: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_33 as u8;
        ...
        887841530443712878 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_5: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_5 as u8;
    ...
    match current_block {
        15818849443713787272 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_34: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_34 as u8;
        ...
        17767742176799939193 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_6: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_6 as u8;
    ...
    match current_block {
        15153555825877660840 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_35: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_35 as u8;
        ...
        16325921850189496668 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_7: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_7 as u8;
    ...
    match current_block {
        1857046018890652364 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_36: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_36 as u8;
        ...
        3202472413399101603 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_8: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_8 as u8;
    ...
    match current_block {
        10292318171587122742 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_37: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_37 as u8;
        ...
        5821827988509819404 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_9: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_9 as u8;
    ...
    match current_block {
        14748314904637597825 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_38: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_38 as u8;
        ...
        5023088878038355716 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_10: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_10 as u8;
    ...
    match current_block {
        4092966239614665407 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_39: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_39 as u8;
        ...
        8515868523999336537 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_11: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_11 as u8;
    ...
    match current_block {
        18234918597811156654 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_12: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_12 as u8;
        ...
        18389040574536762539 => {
            ...
            loop {
                if s.bsLive >= 8 {
                    let v_40: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                    s.bsLive -= 8;
                    uc = v_40 as u8;
    ...
    if current_block == 12310871532727186508 {
        ...
        loop {
            if s.bsLive >= 1 {
                let v_13: u32 = s.bsBuff >> (s.bsLive - 1) & (((1) << 1) - 1) as libc::c_uint;
                s.bsLive -= 1;
    ...
    if current_block == 3338455798814466984 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_14: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_14 as u8;
    ...
    if current_block == 10262367570716242252 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_15: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_15 as u8;
    ...
    if current_block == 17024493544560437554 {
        ...
        loop {
            if s.bsLive >= 8 {
                let v_16: u32 = s.bsBuff >> (s.bsLive - 8) & (((1) << 8) - 1) as libc::c_uint;
                s.bsLive -= 8;
                uc = v_16 as u8;
        ...
        match current_block {
            ...
            9050093969003559074 => {
                ...
                loop {
                    if s.bsLive >= zn {
                        let v_30: u32 =
                            s.bsBuff >> (s.bsLive - zn) & (((1) << zn) - 1) as libc::c_uint;
                        s.bsLive -= zn;
                        zvec = v_30 as i32;
                        break;
                    } else if (*s.strm).avail_in == 0 as libc::c_uint {
            ...
            12127014564286193091 => {
                ...
                loop {
                    if s.bsLive >= 1 {
                        let v_29: u32 =
                            s.bsBuff >> (s.bsLive - 1) & (((1) << 1) - 1) as libc::c_uint;
                        s.bsLive -= 1;
                        zj = v_29 as i32;
                        break;
                    } else if (*s.strm).avail_in == 0 as libc::c_uint {
            ...
            11569294379105328467 => {
                ...
                loop {
                    if s.bsLive >= 5 {
                        let v_23: u32 =
                            s.bsBuff >> (s.bsLive - 5) & (((1) << 5) - 1) as libc::c_uint;
                        s.bsLive -= 5;
                        curr = v_23 as i32;
                        break;
                    } else if (*s.strm).avail_in == 0 as libc::c_uint {
            ...
            14590825336193814119 => {
                ...
                loop {
                    if s.bsLive >= 15 {
                        let v_20: u32 =
                            s.bsBuff >> (s.bsLive - 15) & (((1) << 15) - 1) as libc::c_uint;
                        s.bsLive -= 15;
            ...
            9434444550647791986 => {
                ...
                loop {
                    if s.bsLive >= 3 {
                        let v_19: u32 =
                            s.bsBuff >> (s.bsLive - 3) & (((1) << 3) - 1) as libc::c_uint;
                        s.bsLive -= 3;
                        nGroups = v_19 as i32;
                        break;
                    } else if (*s.strm).avail_in == 0 as libc::c_uint {
                    ...
                    if nextSym == 0 || nextSym == 1 {
                        ...
                        if nn < 16 as libc::c_uint {
                            ...
                            while nn > 3 as libc::c_uint {
                                ...
                                nn = (nn as libc::c_uint).wrapping_sub(4 as libc::c_uint) as u32
                                    as u32;
                            }
                            while nn > 0 as libc::c_uint {
                            ...
                            lno = nn.wrapping_div(16 as libc::c_uint) as i32;
                            off = nn.wrapping_rem(16 as libc::c_uint) as i32;
                ...
                _ => {
                    if s.origPtr < 0 || s.origPtr >= nblock {
                        ...
                        if s.smallDecompress != 0 {
                            ...
                            i = 0;
                            while i < nblock {
                                uc = (*(s.tt).offset(i as isize) & 0xff as libc::c_uint) as u8;
                            ...
                            if s.blockRandomised != 0 {
                                ...
                                s.k0 = (s.tPos & 0xff as libc::c_uint) as u8 as i32;
                                s.tPos >>= 8;
                                s.nblock_used += 1;
                                if s.rNToGo == 0 {
                                    s.rNToGo = BZ2_RNUMS[s.rTPos as usize];
