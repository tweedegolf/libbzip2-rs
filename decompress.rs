...
pub unsafe fn BZ2_decompress(s: &mut DState) -> i32 {
        ...
        BZ_X_MAGIC_1 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
    ...
    if current_block == 15360092558900836893 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_0: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                ...
                s.bsBuff = s.bsBuff << 8 as libc::c_int | *((*s.strm).next_in as *mut u8) as u32;
                s.bsLive += 8 as libc::c_int;
                (*s.strm).next_in = ((*s.strm).next_in).offset(1);
                (*s.strm).next_in;
                (*s.strm).avail_in = ((*s.strm).avail_in).wrapping_sub(1);
    ...
    if current_block == 15953825877604003206 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_1: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
                uc = v_1 as u8;
                current_block = 178030534879405462;
    ...
    if current_block == 1137006006685247392 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_2: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
    ...
    if current_block == 16838365919992687769 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_3: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
                uc = v_3 as u8;
                current_block = 16937825661756021828;
    ...
    match current_block {
        14366592556287126287 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_32: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_32 as u8;
        ...
        5889181040567946013 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_4: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_4 as u8;
    ...
    match current_block {
        7651522734817633728 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_33: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_33 as u8;
        ...
        887841530443712878 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_5: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_5 as u8;
    ...
    match current_block {
        15818849443713787272 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_34: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_34 as u8;
        ...
        17767742176799939193 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_6: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_6 as u8;
    ...
    match current_block {
        15153555825877660840 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_35: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_35 as u8;
        ...
        16325921850189496668 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_7: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_7 as u8;
    ...
    match current_block {
        1857046018890652364 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_36: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_36 as u8;
        ...
        3202472413399101603 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_8: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_8 as u8;
    ...
    match current_block {
        10292318171587122742 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_37: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_37 as u8;
        ...
        5821827988509819404 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_9: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_9 as u8;
    ...
    match current_block {
        14748314904637597825 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_38: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_38 as u8;
        ...
        5023088878038355716 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_10: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_10 as u8;
    ...
    match current_block {
        4092966239614665407 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_39: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_39 as u8;
        ...
        8515868523999336537 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_11: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_11 as u8;
    ...
    match current_block {
        18234918597811156654 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_12: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_12 as u8;
        ...
        18389040574536762539 => {
            ...
            loop {
                ...
                if s.bsLive >= 8 as libc::c_int {
                    let v_40: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                        & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                            as libc::c_uint;
                    s.bsLive -= 8 as libc::c_int;
                    uc = v_40 as u8;
    ...
    if current_block == 12310871532727186508 {
        ...
        loop {
            ...
            if s.bsLive >= 1 as libc::c_int {
                let v_13: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
    ...
    if current_block == 3338455798814466984 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_14: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
                uc = v_14 as u8;
                current_block = 5948065351908552372;
    ...
    if current_block == 10262367570716242252 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_15: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
                uc = v_15 as u8;
                current_block = 8940662058537996670;
    ...
    if current_block == 17024493544560437554 {
        ...
        loop {
            ...
            if s.bsLive >= 8 as libc::c_int {
                let v_16: u32 = s.bsBuff >> (s.bsLive - 8 as libc::c_int)
                    & (((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int) as libc::c_uint;
                s.bsLive -= 8 as libc::c_int;
                uc = v_16 as u8;
                current_block = 13366002463409402866;
        ...
        match current_block {
            ...
            _ => {
                ...
                if s.origPtr < 0 as libc::c_int {
                    retVal = -4 as libc::c_int;
                    current_block = 3350591128142761507;
                } else if s.origPtr > 10 as libc::c_int + 100000 as libc::c_int * s.blockSize100k {
                    retVal = -4 as libc::c_int;
                    current_block = 3350591128142761507;
                } else {
                    i = 0 as libc::c_int;
    ...
    'c_10064: loop {
        match current_block {
            ...
            9050093969003559074 => {
                ...
                loop {
                    if s.bsLive >= zn {
                        let v_30: u32 = s.bsBuff >> (s.bsLive - zn)
            ...
            12127014564286193091 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_29: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
            ...
            9335356017384149594 => {
                ...
                loop {
                    if s.bsLive >= zn {
                        let v_28: u32 = s.bsBuff >> (s.bsLive - zn)
                            & (((1 as libc::c_int) << zn) - 1 as libc::c_int) as libc::c_uint;
                        s.bsLive -= zn;
                        zvec = v_28 as i32;
                        break;
            ...
            1010107409739284736 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_27: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        zj = v_27 as i32;
            ...
            13155828021133314705 => {
                ...
                loop {
                    if s.bsLive >= zn {
                        let v_26: u32 = s.bsBuff >> (s.bsLive - zn)
                            & (((1 as libc::c_int) << zn) - 1 as libc::c_int) as libc::c_uint;
                        s.bsLive -= zn;
                        zvec = v_26 as i32;
                        break;
            ...
            7191958063352112897 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_25: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        uc = v_25 as u8;
            ...
            17216244326479313607 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_24: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        uc = v_24 as u8;
            ...
            11569294379105328467 => {
                ...
                loop {
                    if s.bsLive >= 5 as libc::c_int {
                        let v_23: u32 = s.bsBuff >> (s.bsLive - 5 as libc::c_int)
            ...
            15957329598978927534 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_21: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        uc = v_21 as u8;
            ...
            14590825336193814119 => {
                ...
                loop {
                    if s.bsLive >= 15 as libc::c_int {
                        let v_20: u32 = s.bsBuff >> (s.bsLive - 15 as libc::c_int)
            ...
            9434444550647791986 => {
                ...
                loop {
                    if s.bsLive >= 3 as libc::c_int {
                        let v_19: u32 = s.bsBuff >> (s.bsLive - 3 as libc::c_int)
            ...
            15451013008180677144 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_18: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        uc = v_18 as u8;
                ...
                if uc == 1 {
                    s.inUse[(i * 16 as libc::c_int + j) as usize] = 1 as Bool;
                }
                j += 1;
            ...
            1154520408629132897 => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_17: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        uc = v_17 as u8;
            ...
            _ => {
                ...
                loop {
                    if s.bsLive >= 1 as libc::c_int {
                        let v_31: u32 = s.bsBuff >> (s.bsLive - 1 as libc::c_int)
                            & (((1 as libc::c_int) << 1 as libc::c_int) - 1 as libc::c_int)
                                as libc::c_uint;
                        s.bsLive -= 1 as libc::c_int;
                        zj = v_31 as i32;
                ...
                if zn > 20 as libc::c_int {
                        ...
                        || zvec - *gBase.offset(zn as isize) >= 258 as libc::c_int
                    {
                        ...
                        if nextSym == 0 as libc::c_int || nextSym == 1 as libc::c_int {
                            ...
                            es += 1;
                            uc = s.seqToUnseq
                                [s.mtfa[s.mtfbase[0 as libc::c_int as usize] as usize] as usize];
                    ...
                    if nextSym == 0 as libc::c_int || nextSym == 1 as libc::c_int {
                        ...
                        if nn < 16 as libc::c_int as libc::c_uint {
                            ...
                            while nn > 0 as libc::c_int as libc::c_uint {
                                s.mtfa[(pp as libc::c_uint).wrapping_add(nn) as usize] = s.mtfa[(pp
                                    as libc::c_uint)
                                    .wrapping_add(nn)
                            ...
                            while pp > s.mtfbase[lno as usize] {
                                s.mtfa[pp as usize] = s.mtfa[(pp - 1 as libc::c_int) as usize];
                                pp -= 1;
                            }
                            ...
                            while lno > 0 as libc::c_int {
                                s.mtfbase[lno as usize] -= 1;
                                s.mtfbase[lno as usize];
                                s.mtfa[s.mtfbase[lno as usize] as usize] = s.mtfa[(s.mtfbase
                                    [(lno - 1 as libc::c_int) as usize]
                                    + 16 as libc::c_int
                                    - 1 as libc::c_int)
                                    as usize];
                                lno -= 1;
                ...
                _ => {
                    if s.origPtr < 0 as libc::c_int || s.origPtr >= nblock {
                        ...
                        if s.smallDecompress != 0 {
                            ...
                            while i < nblock {
                                ...
                                *(s.ll16).offset(i as isize) =
                                ...
                                if i & 0x1 as libc::c_int == 0 as libc::c_int {
                                    *(s.ll4).offset((i >> 1 as libc::c_int) as isize) = (*(s.ll4)
                            ...
                            loop {
                                let tmp_0: i32 = (*(s.ll16).offset(j as isize) as u32
                                    | (*(s.ll4).offset((j >> 1 as libc::c_int) as isize) as u32
                                        ...
                                        << 16 as libc::c_int)
                                    as i32;
                                *(s.ll16).offset(j as isize) = (i & 0xffff as libc::c_int) as u16;
                                if j & 0x1 as libc::c_int == 0 as libc::c_int {
                                    *(s.ll4).offset((j >> 1 as libc::c_int) as isize) = (*(s.ll4)
                            ...
                            s.tPos = *(s.tt).offset(s.origPtr as isize) >> 8 as libc::c_int;
                            s.nblock_used = 0 as libc::c_int;
                            if s.blockRandomised != 0 {
                                s.rNToGo = 0 as libc::c_int;
                                s.rTPos = 0 as libc::c_int;
